<template>
  <footer class="footer">
    <div class="footer_container1">
      <img src="/images/logos/bella_logo_white.png" alt="" />

      <div class="footer_block">
        <h2>Service client</h2>
        <ul class="footer_blocklist">
          <li>
            <a href="mailto:contact@bellagp.fr">contact@bellagp.fr</a>
          </li>
        </ul>
      </div>
      ...
      <div class="footer_block">
        ...
        <ul>
          ...
          <li>
            <a
              href="https://www.instagram.com/bellagp971?igsh=MTl1dGJ6bmhoanZiOQ=="
              target="_blank"
            >
              <svg
          ...
          <li>
            <a
              href="https://www.facebook.com/share/1BNieqUtKj/?mibextid=wwXIfr"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
