<template>
  <div class="login">
    <div class="navbar_area"></div>

    <div class="login_container">
      <div class="login_container_image">
        <img src="/images/logos/bella_logo_black.png" alt="" />
        <p>
          Retrouve tes coups de cœur, tes commandes et toutes nos nouveautés.
        </p>
      </div>

      <div class="login_container_forms">
        <div v-if="!awaitingConfirmAccount" class="login_container_forms_title">
          <h1>Connexion</h1>
          <div class="login_container_forms_subtitle">
            <p>Bonjour, tu nous avais manqué !</p>
          </div>
        </div>

        <div
          v-if="!awaitingConfirmAccount"
          class="login_container_forms_inputs"
        >
          ...
          <button class="button--secondary" @click="handleLogin()">
            Connecte-toi
          </button>
        ...
        <!--<div v-if="awaitingConfirmAccount">-->
        <div v-if="awaitingConfirmAccount" class="login_container_forms_code">
          <div class="login_container_forms_code_title">
            <h1>
              Confirmer votre connexion avec le code envoyé à votre adresse mail
            </h1>
            <p>{{ email }}</p>
          </div>

          <div class="login_container_forms_code_inputs">
            <input
              ref="codeInput1"
              type="text"
              maxlength="1"
          ...
          <div class="login_container_forms_code_send_new_code">
